...
#%%
def load_data():
    df = pd.read_csv(r"~/dp/eif3a_full_test_conposition.csv")
...
def lossplot(history):
    ...
    plt.legend()
    # plt.show()
    plt.savefig('/home/yuxuan/dp/conposition/loss_conposition.png')
    print("")
...
def roc(model, x_test, y_test):
    ...
    plt.savefig('/home/yuxuan/dp/conposition/ROC_conposition.png')
    return auc_keras
...
def prcurve(model, x_test, y_test):
    ...
    # show the plot
    # pyplot.show()
    plt.savefig('/home/yuxuan/dp/conposition/PRAUC_conposition.png')
    return lr_auc
...
def main():
    ...
    np.savetxt('/home/yuxuan/dp/conposition/eif3a_full_conposition.csv', results, delimiter=',')
