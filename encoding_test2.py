...
#%%
def load_data():
    df = pd.read_csv("eif3a_full_test_onehot.csv")
...
def lossplot(history):
    ...
    plt.legend()
    # plt.show()
    plt.savefig('/home/yuxuan/dp/onehot_notMDF/loss_onehot_notMDF.png')
    print("")
...
def roc(model, x_test, y_test):
    ...
    plt.savefig('/home/yuxuan/dp/onehot_notMDF/ROC_onehot_notMDF.png')
    return auc_keras
...
def prcurve(model, x_test, y_test):
    ...
    # show the plot
    # pyplot.show()
    plt.savefig('/home/yuxuan/dp/onehot_notMDF/PRAUC_onehot_notMDF.png')
    return lr_auc
...
def main():
    ...
    np.savetxt('/home/yuxuan/dp/onehot_notMDF/eif3a_full_onehot_notMDF.csv', results, delimiter=',')
